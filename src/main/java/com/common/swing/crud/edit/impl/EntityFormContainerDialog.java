...
public abstract class EntityFormContainerDialog<E extends Persistence<PK>, PK extends Serializable> extends JDialog implements
	...
	private static final long serialVersionUID = 3763950103608728922L;

	private static final Logger logger = Logger.getLogger(EntityFormContainerDialog.class);
	...
	public EntityFormContainerDialog<E, PK> createNewForm() {
		EntityFormContainerDialog.logger.trace("createNewForm");
	...
	public EntityFormContainerDialog<E, PK> createEditForm(E editEntity) {
		EntityFormContainerDialog.logger.trace("createEditForm");
