 ...
 */
public class ListDialog<E extends Persistence<PK>, PK extends Serializable> extends GenericDialogOld {
	 ...
	 */
	private static final Logger log = Logger.getLogger(ListDialog.class);
	...
	public ListDialog() {
		super();
		ListDialog.log.trace("EntityListDialog create");
	 ...
	 */
	private void init() {
		ListDialog.log.trace("EntityListDialog init");
	...
	// // Entrada al LOG.
	// ListDialog.log.trace("EntityListDialog setEntityListPanel");
	//
	...
	// this.pack();
	// } else {
	// ListDialog.log.info("EntityListDialog setEntityListPanel entityListPanel null");
	// }
	// }
